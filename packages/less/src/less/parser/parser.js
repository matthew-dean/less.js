  ...
  return {
    ...
    parse: function (str, callback, additionalData) {
      ...
      if (globalVars || (additionalData && additionalData.banner)) {
        preText
          = (additionalData && additionalData.banner ? additionalData.banner : '') + globalVars
    ...
    parsers: (parsers = {
      ...
      entities: {
        ...
        color: function () {
          ...
          if (
            ...
            && (rgb = parserInput.$re(/^#([A-Fa-f0-9]{8}|[A-Fa-f0-9]{6}|[A-Fa-f0-9]{3,4})([\w.#\[])?/))
          ) {
            if (!rgb[2]) {
              parserInput.forget()
      ...
      variableCall: function (parsedName) {
        ...
        if (
          name
          || (parserInput.currentChar() === '@' && (name = parserInput.$re(/^(@[\w-]+)(\(\s*\))?/)))
        ) {
          ...
          if (e) {
            ...
            if (parserInput.$char(')')) {
              if (p && e) {
                nodes.push(
                  new tree.Paren(
                    new tree.Declaration(p, e, null, null, parserInput.i, fileInfo, true)
                  )
                )
              } else if (e) {
