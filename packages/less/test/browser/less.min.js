...
!(function(e, t) {
    ...
    var n = {
        createCSS: function(t, n, i) {
            ...
            if ((s && !1 === o && s.parentNode.removeChild(s), l.styleSheet))
                try {
        ...
        currentScript: function(e) {
            ...
            return (
                n.currentScript ||
                (t = n.getElementsByTagName("script"))[t.length - 1]
            );
        }
    };
    function i(e) {
                ...
                Array.isArray(e)
                    ...
                    ? ((a.rgb = []),
                      e.match(/.{2}/g).map(function(e, t) {
                          t < 3
                              ? s.rgb.push(parseInt(e, 16))
                              : (s.alpha = parseInt(e, 16) / 255);
                      }))
                    : ((a.rgb = []),
                      e.split("").map(function(e, t) {
                          t < 3
                              ? s.rgb.push(parseInt(e + e, 16))
                              : (s.alpha = parseInt(e + e, 16) / 255);
                      })),
                (a.alpha = a.alpha || ("number" == typeof n ? n : 1)),
                void 0 !== i && (a.value = i),
                a
            );
        }
            ...
            s(t, [
                ...
                },
                {
                    ...
                    value: function(e, n, i) {
                        for (
                            var r = new Array(3),
                                a = this.alpha * (1 - i.alpha) + i.alpha,
                                s = 0;
                            s < 3;
                            s++
                        )
    ...
    (y.prototype.type = "Color"),
        (y.fromKeyword = function(e) {
            var t,
                n = e.toLowerCase();
            if (
                (v.hasOwnProperty(n)
                    ? (t = new y(v[n].slice(1)))
                    : "transparent" === n && (t = new y([0, 0, 0], 0)),
                t)
            )
                return (t.value = e), t;
        });
    ...
    var I = (function(e) {
        function t(e, n, i, a, s, o) {
            ...
            return (
                r(this, t),
                ((u = f(this, l(t).call(this))).combinator =
                    e instanceof S ? e : new S(e)),
                (u.value = "string" == typeof n ? n.trim() : n || ""),
                (u.isVariable = i),
                (u._index = a),
                (u._fileInfo = s),
                u.copyVisibilityInfo(o),
                u.setParent(u.combinator, h(u)),
                u
            );
        }
        return (
            ...
            s(t, [
                {
                    ...
                    value: function(e) {
                        ...
                        (this.combinator = e.visit(this.combinator)),
                            "object" === i(t) && (this.value = e.visit(t));
                    }
                },
                {
                    key: "eval",
                ...
                },
                {
                    ...
                    value: function() {
                        var e =
                            ...
                            n = e.firstSelector;
                        return (
                            t instanceof k && (e.firstSelector = !0),
    ...
    var C = { ALWAYS: 0, PARENS_DIVISION: 1, PARENS: 2, STRICT_LEGACY: 3 },
        _ = { OFF: 0, LOCAL: 1, ALL: 2 };
    var A = (function(e, t) {
                    ...
                    (function a(l, v) {
                        ...
                        l)) {
                            ...
                            m && (b = Object.getOwnPropertyDescriptor(m, y)),
                                (b && null == b.set) || (d[y] = a(l[y], v - 1));
                        }
                        if (Object.getOwnPropertySymbols) {
                            var w = Object.getOwnPropertySymbols(l);
                            for (y = 0; y < w.length; y++) {
                                var k = w[y];
                                (!(S = Object.getOwnPropertyDescriptor(l, k)) ||
                                    S.enumerable ||
                                    c) &&
                                    ((d[k] = a(l[k], v - 1)),
                                    S.enumerable ||
                        ...
                        if (c) {
                            ...
                            for (y = 0; y < x.length; y++) {
                                var S,
                                    I = x[y];
                                ((S = Object.getOwnPropertyDescriptor(l, I)) &&
                                    S.enumerable) ||
                                    ((d[I] = a(l[I], v - 1)),
    ...
    function O(e, t) {
        ...
        var n = R(e, t);
        if (
            (n.strictMath && (n.math = C.STRICT_LEGACY),
            n.relativeUrls && (n.rewriteUrls = _.ALL),
    ...
    ($.prototype.constructor = $),
        ($.prototype.toString = function() {
            ...
            if (null !== this.line) {
                if (
                    ...
                    n[1] &&
                        (o +=
                            ...
                            a(
                                a(
                                    a(n[1].substr(this.column, 1), "bold") +
                ...
                "string" == typeof n[2] &&
                    r.push(
                        a("".concat(this.line + 1, " ").concat(n[2]), "grey")
                    ),
                    (r = "".concat(r.join("\n") + a("", "reset"), "\n"));
            }
            return (
                ...
                this.filename && (t += a(" in ", "red") + this.filename),
                this.line &&
                    (t += a(
                        " on line "
                ...
                this.callLine &&
                    ((t += "".concat(
                        a("from ", "red") + (this.filename || ""),
                        "/n"
                    )),
                    (t += ""
                        .concat(a(this.callLine, "grey"), " ")
    ...
    var D = (function(e) {
        function t(e, n, i, a, s, o) {
            ...
            return (
                r(this, t),
                ((u = f(this, l(t).call(this))).extendList = n),
                (u.condition = i),
                (u.evaldCondition = !i),
                (u._index = a),
                (u._fileInfo = s),
                (u.elements = u.getElements(e)),
                (u.mixinElements_ = void 0),
                u.copyVisibilityInfo(o),
                u.setParent(u.elements, h(u)),
                u
            );
        }
        return (
                    ...
                    value: function(e) {
                        return e
                            ? ("string" == typeof e &&
                              ...
                              e)
                            : [new I("", "&", !1, this._index, this._fileInfo)];
                    }
                },
                {
    ...
    var N = (function(e) {
        function t(e) {
            var n;
            if ((r(this, t), (n = f(this, l(t).call(this))), !e))
    ...
    var B = (function(e) {
        function t(e, n, i, a, s, o) {
            ...
            return (
                r(this, t),
                ((u = f(this, l(t).call(this))).value = e),
                (u._index = n),
                (u._fileInfo = i),
                (u.mapLines = a),
                (u.rulesetLike = void 0 !== s && s),
                (u.allowRoot = !0),
                u.copyVisibilityInfo(o),
                u
            );
        ...
        return (
            ...
            s(t, [
                ...
                },
                {
                    key: "compare",
                    value: function(e) {
                        return e.toCSS && this.toCSS() === e.toCSS()
                            ? 0
                            : void 0;
                    }
                },
    ...
    var U = C,
        q = (function(e) {
            function t(e, n, i, a, s, o, u, c) {
                ...
                return (
                    r(this, t),
                    ((p = f(this, l(t).call(this))).name = e),
                    (p.value =
                        n instanceof g ? n : new N([n ? new B(n) : null])),
                    (p.important = i ? " ".concat(i.trim()) : ""),
                    (p.merge = a),
                    (p._index = s),
                    (p._fileInfo = o),
                    (p.inline = u || !1),
                    (p.variable =
                        void 0 !== c ? c : e.charAt && "@" === e.charAt(0)),
                    (p.allowRoot = !0),
                    p.setParent(p.value, h(p)),
                    p
                );
            }
            return (
    ...
    var z = (function(e) {
        function t(e, n, i, a) {
            ...
            return (
                r(this, t),
                ((s = f(this, l(t).call(this))).value = e),
                (s.isLineComment = n),
                (s._index = i),
                (s._fileInfo = a),
                (s.allowRoot = !0),
            ...
            s(t, [
                {
                    ...
                    value: function(e, t) {
                        this.debugInfo &&
                            t.add(T(e, this), this.fileInfo(), this.getIndex()),
                            t.add(this.value);
                    }
                },
                {
    ...
    var Z = (function e(t) {
        ...
        X = (function(e) {
            function t(e, n, i, a) {
                ...
                return (
                    r(this, t),
                    ((s = f(this, l(t).call(this))).selectors = e),
                    (s.rules = n),
                    (s._lookups = {}),
                    (s._variables = null),
                    (s._properties = null),
                    (s.strictImports = i),
                    s.copyVisibilityInfo(a),
                    (s.allowRoot = !0),
                    s.setParent(s.selectors, h(s)),
                    s.setParent(s.rules, h(s)),
                    s
                );
            }
            return (
                ...
                s(t, [
                    ...
                    },
                    {
                        ...
                        value: function(e) {
                            ...
                            var c,
                                h,
                                f = this.rules ? P(this.rules) : null,
                                v = new t(
                                    n,
                                    f,
                                    this.strictImports,
                            ...
                            var y = v.rules;
                            for (a = 0; (c = y[a]); a++)
                                c.evalFirst && (y[a] = c.eval(e));
                            var b =
                                (e.mediaBlocks && e.mediaBlocks.length) || 0;
                            for (a = 0; (c = y[a]); a++)
                                "MixinCall" === c.type
                                    ? ((f = c.eval(e).filter(function(e) {
                                          return (
                                              !(e instanceof q && e.variable) ||
                                              !v.variable(e.name)
                                          );
                                      })),
                                      y.splice.apply(y, p([a, 1].concat(f))),
                                      (a += f.length - 1),
                                      v.resetCache())
                                    : "VariableCall" === c.type &&
                            ...
                            for (a = 0; (c = y[a]); a++)
                                if (
                                    ...
                                    y.splice(a--, 1);
                                    for (l = 0; (h = c.rules[l]); l++)
                                        h instanceof g &&
                                            (h.copyVisibilityInfo(
                                                c.visibilityInfo()
                                            ),
                                            (h instanceof q && h.variable) ||
                                                y.splice(++a, 0, h));
                                }
                            if ((d.shift(), m.shift(), e.mediaBlocks))
                                for (a = b; a < e.mediaBlocks.length; a++)
                                    e.mediaBlocks[a].bubbleSelectors(n);
                            return v;
                        }
                    },
                    {
                    ...
                    },
                    {
                        ...
                        value: function(e, t) {
                            ...
                            return (
                                ...
                                !(
                                    n.condition &&
                                    !n.condition.eval(new G.Eval(t, t.frames))
                                )
                            );
                        }
                    },
                    ...
                    },
                    {
                        ...
                        value: function(e) {
                            var t = this;
                            function n(e) {
                                return e.value instanceof B && !e.parsed
                            ...
                            return s in this._lookups
                                ...
                                : (this.rulesets().forEach(function(s) {
                                      if (s !== i)
                                          for (
                                              var o = 0;
                                              o < s.selectors.length;
                                              o++
                                          )
                                              if (
                                                  (t = e.match(s.selectors[o]))
                                              ) {
                    ...
                    },
                    {
                        ...
                        value: function(e, t) {
                            ...
                            var l,
                                u = e.compress
                                    ? ""
                                    : Array(e.tabLevel + 1).join("  "),
                                c = e.compress
                                    ? ""
                                    : Array(e.tabLevel).join("  "),
                                h = 0,
                                f = 0;
                            for (n = 0; (a = this.rules[n]); n++)
                                a instanceof z
                                    ? (f === n && f++, o.push(a))
                            ...
                            for (n = 0; (a = o[n]); n++) {
                                ...
                                var m = e.lastRule;
                                a.isRulesetLike(a) && (e.lastRule = !1),
                                    a.genCSS
                                        ? a.genCSS(e, t)
                                        : a.value && t.add(a.value.toString()),
                                    (e.lastRule = m),
                                    !e.lastRule && a.isVisible()
                                        ? t.add(
                                              e.compress ? "" : "\n".concat(u)
                                          )
                                        : (e.lastRule = !1);
                        ...
                        value: function(e, t, n) {
                            ...
                            function a(e, t, n, i) {
                                ...
                                if (
                                    ...
                                    e.length > 0
                                        ? ((a = (r = P(e)).pop()),
                                          (s = i.createDerived(P(a.elements))))
                                        : (s = i.createDerived([])),
                                    t.length > 0)
                                ) {
                                    var o = n.combinator,
                                    ...
                                    o.emptyOrWhitespace &&
                                        ...
                                        (s.elements = s.elements.concat(
                                            t[0].elements.slice(1)
                                        ));
                                }
                                if (
                                    (0 !== s.elements.length && r.push(s),
                                    t.length > 1)
                                ) {
                                    var u = t.slice(1);
                                    (u = u.map(function(e) {
                                ...
                                !(function e(t, n, l) {
                                    ...
                                    for (
                                        ...
                                        if ("&" !== m.value) {
                                            var S =
                                                ((w = void 0),
                                                (b = m).value instanceof k &&
                                                (w = b.value.value) instanceof D
                                                    ? w
                                                    : null);
                                            if (null != S) {
                                                o(f, p);
    ...
    var ee = (function(e) {
        function t(e, n, i, a, s, o, u, c) {
            ...
            if (
                (r(this, t),
                ((p = f(this, l(t).call(this))).name = e),
                (p.value = n instanceof g ? n : n ? new B(n) : n),
                i)
            ) {
                for (
                    Array.isArray(i)
            ...
            s(t, [
                ...
                },
                {
                    ...
                    value: function(e, t, n) {
                        ...
                        if (r) {
                            for (
                                t.add(" {".concat(s)), n[0].genCSS(e, t), i = 1;
                                i < r;
                                i++
                            )
    ...
    var te = (function(e) {
        function t(e, n) {
            ...
            return (
                r(this, t),
                ((i = f(this, l(t).call(this))).ruleset = e),
                (i.frames = n),
                i.setParent(i.ruleset, h(i)),
                i
            );
        }
        return (
                ...
                },
                {
                    ...
                    value: function(e) {
                        return this.ruleset.eval(
                            this.frames
                                ? new G.Eval(e, this.frames.concat(e.frames))
                                : e
                        );
                    }
                }
    ...
    var ne = (function(e) {
        function t(e, n, i) {
            ...
            return (
                r(this, t),
                ((a = f(this, l(t).call(this))).numerator = e
                    ? P(e).sort()
                    : []),
                (a.denominator = n ? P(n).sort() : []),
                i ? (a.backupUnit = i) : e && e.length && (a.backupUnit = e[0]),
                a
            );
        }
        return (
            ...
            s(t, [
                ...
                },
                {
                    ...
                    value: function(e) {
                        return (
                            this.toString().toUpperCase() === e.toUpperCase()
                        );
                    }
                },
                {
                ...
                },
                {
                    ...
                    value: function() {
                        ...
                        for (n in ((t = function(t) {
                            return (
                                e.hasOwnProperty(t) && !i[n] && (i[n] = t), t
                            );
                        }),
                        d))
                            d.hasOwnProperty(n) && ((e = d[n]), this.map(t));
                        return i;
                    }
                },
                {
    ...
    var ie = (function(e) {
        function t(e, n) {
            ...
            if (
                (r(this, t),
                ((i = f(this, l(t).call(this))).value = parseFloat(e)),
                isNaN(i.value))
            )
                throw new Error("Dimension is not a number.");
            return (
                (i.unit = n && n instanceof ne ? n : new ne(n ? [n] : void 0)),
                i.setParent(i.unit, h(i)),
                i
            );
        }
        return (
            ...
            s(t, [
                ...
                },
                {
                    ...
                    value: function(e, n, i) {
                        ...
                        if ("+" === n || "-" === n)
                            if (
                                0 === a.numerator.length &&
                                0 === a.denominator.length
                            )
                                (a = i.unit.clone()),
                                    this.unit.backupUnit &&
                                        (a.backupUnit = this.unit.backupUnit);
                            else if (
                                ...
                                if (
                                    ...
                                    e.strictUnits &&
                                        i.unit.toString() !== a.toString())
                                )
                                    throw new Error(
                                        "Incompatible units. Change the units or use the unit function. " +
                                            "Bad units: '"
                                                .concat(a.toString(), "' and '")
                                                .concat(i.unit.toString(), "'.")
                                    );
                ...
                },
                {
                    ...
                    value: function(e) {
                        ...
                        if ("string" == typeof e) {
                            for (n in d)
                                d[n].hasOwnProperty(e) && ((u = {})[n] = e);
                            e = u;
                        }
                        for (i in ((s = function(e, t) {
                            return r.hasOwnProperty(e)
                                ? (t ? (o /= r[e] / r[a]) : (o *= r[e] / r[a]),
                                  a)
                                : e;
                        }),
                        e))
    ...
    var re = C,
        ae = (function(e) {
            function t(e, n, i) {
                ...
                return (
                    r(this, t),
                    ((a = f(this, l(t).call(this))).op = e.trim()),
                    (a.operands = n),
                    (a.isSpaced = i),
                    a
                );
    ...
    var se = C,
        oe = (function(e) {
            function t(e, n) {
                ...
                if (
                    (r(this, t),
                    ((i = f(this, l(t).call(this))).value = e),
                    (i.noSpacing = n),
                    !e)
                )
    ...
    var le = (function() {
            function e(t, n, i, a) {
                r(this, e),
                    ...
                    (this.func = n.frames[0].functionRegistry.get(this.name));
            }
            return (
                s(e, [
                    {
            ...
            s(t, [
                {
                    ...
                    value: function(e) {
                        ...
                        if (
                            ...
                            throw {
                                type: "Name",
                                message: "Recursive variable definition for ".concat(
                                    i
                                ),
                                filename: this.fileInfo().filename,
                                index: this.getIndex()
            ...
            s(t, [
                {
                    ...
                    value: function(e) {
                        var t,
                            n = this.name,
                            i =
                                e.pluginManager.less.visitors.ToCSSVisitor
                                    .prototype._mergeRules;
                        if (this.evaluating)
                            throw {
                                type: "Name",
                                message: "Recursive property reference for ".concat(
                                    n
                                ),
                                filename: this.fileInfo().filename,
                                index: this.getIndex()
                        ...
                        if (
                            ...
                            (t = this.find(e.frames, function(t) {
                                ...
                                if (a) {
                                    ...
                                    if ((i(a), (r = a[a.length - 1]).important))
                                        e.importantScope[
                                            e.importantScope.length - 1
    ...
    var pe = (function(e) {
        function t(e, n, i, a, s) {
            ...
            return (
                r(this, t),
                ((o = f(this, l(t).call(this))).escaped = null == i || i),
                (o.value = n || ""),
                (o.quote = e.charAt(0)),
                (o._index = a),
                (o._fileInfo = s),
    ...
    var de = (function(e) {
        function t(e, n, i, a, s) {
            var o;
            r(this, t),
                ((o = f(this, l(t).call(this)))._index = i),
                (o._fileInfo = a);
            var u = new D(
                [],
                null,
            ...
            return (
                (o.features = new N(n)),
                (o.rules = [new X(u, e)]),
                (o.rules[0].allowImports = !0),
                o.copyVisibilityInfo(s),
                (o.allowRoot = !0),
                o.setParent(u, h(o)),
                o.setParent(o.features, h(o)),
                o.setParent(o.rules, h(o)),
                o
            );
        }
        return (
            ...
            s(t, [
                ...
                },
                {
                    ...
                    value: function(e) {
                        ...
                        if (e.mediaBlocks.length > 1) {
                            ...
                            ((t = new X(n, e.mediaBlocks)).multiMedia = !0),
                ...
                },
                {
                    ...
                    value: function(e) {
                        ...
                        for (
                            var t = [], n = this.permute(e.slice(1)), i = 0;
                            i < n.length;
                            i++
                        )
                            for (var r = 0; r < e[0].length; r++)
                                t.push([e[0][r]].concat(n[i]));
                        return t;
                    }
                },
                {
                    ...
                    value: function(e) {
                        e &&
                            ((this.rules = [new X(P(e), [this.rules[0]])]),
    ...
    var me = (function(e) {
        function t(e, n, i, a, s, o) {
            ...
            if (
                (r(this, t),
                ((u = f(this, l(t).call(this))).options = i),
                (u._index = a),
                (u._fileInfo = s),
                (u.path = e),
                (u.features = n),
            ...
            return (
                u.copyVisibilityInfo(o),
                u.setParent(u.features, h(u)),
                u.setParent(u.path, h(u)),
                u
            );
        }
        return (
            ...
            s(t, [
                ...
                },
                {
                    ...
                    value: function(e, t) {
                        this.css &&
                            ...
                            this.features &&
                                (t.add(" "), this.features.genCSS(e, t)),
                            t.add(";"));
                    }
                },
                {
                    key: "getPath",
                    value: function() {
                        return this.path instanceof ve
                ...
                },
                {
                    ...
                    value: function() {
                        ...
                        return (
                            ...
                            !(e instanceof pe) || e.containsVariables()
                        );
                    }
                },
                {
                ...
                },
                {
                    ...
                    value: function(e) {
                        ...
                        return (
                            (n = new X(null, P(this.root.rules))).evalImports(
                                e
                            ),
                            this.features
                                ? new de(n.rules, this.features.value)
                                : n.rules
                        );
                    }
                }
    ...
    var ge = (function(e) {
        ...
        ye = (function(e) {
            function t(e, n, i, a) {
                ...
                return (
                    r(this, t),
                    ((s = f(this, l(t).call(this))).escaped = n),
                    (s.expression = e),
                    (s._index = i),
                    (s._fileInfo = a),
                    s
                ...
                },
                {
                    ...
                    value: function(e) {
                        return this.value.eval
                            ? new t(this.key, this.value.eval(e))
                            : this;
                    }
                },
                {
    ...
    var we = (function(e) {
        function t(e, n, i, a, s) {
            ...
            return (
                r(this, t),
                ((o = f(this, l(t).call(this))).op = e.trim()),
                (o.lvalue = n),
                (o.rvalue = i),
                (o._index = a),
                (o.negate = s),
        ...
        return (
            ...
            s(t, [
                ...
                },
                {
                    ...
                    value: function(e) {
                        return e.isMathOn()
                            ? new ae("*", [new ie(-1), this.value]).eval(e)
    ...
    var Se = (function(e) {
        function t(e, n, i, a, s) {
            ...
            switch (
                (r(this, t),
                ((o = f(this, l(t).call(this))).selector = e),
                (o.option = n),
                (o.object_id = t.next_id++),
                (o.parent_ids = [o.object_id]),
                (o._index = i),
                (o._fileInfo = a),
                o.copyVisibilityInfo(s),
                (o.allowRoot = !0),
    ...
    var Ie = (function(e) {
        function t(e, n, i) {
            ...
            return (
                r(this, t),
                ((a = f(this, l(t).call(this))).variable = e),
                (a._index = n),
                (a._fileInfo = i),
                (a.allowRoot = !0),
                a
            ...
            s(t, [
                {
                    ...
                    value: function(e) {
                        var t,
                            ...
                            i = new $({
                                message: "Could not evaluate variable call ".concat(
                                    this.variable
                                )
                            });
                        if (!n.ruleset) {
    ...
    var Ce = (function(e) {
        function t(e, n, i, a, s) {
            ...
            return (
                r(this, t),
                ((o = f(this, l(t).call(this))).value = e),
                (o.lookups = n),
                (o.important = i),
                (o._index = a),
                (o._fileInfo = s),
            ...
            s(t, [
                {
                    ...
                    value: function(e) {
                        ...
                        for (t = 0; t < this.lookups.length; t++) {
                            if (
                                ((n = this.lookups[t]),
                                Array.isArray(i) && (i = new X([new D()], i)),
                                "" === n)
                            )
                                i = i.lastDeclaration();
                            else if ("@" === n.charAt(0)) {
                                if (
                                    ("@" === n.charAt(1) &&
                                        (n = "@".concat(
                                            new ce(n.substr(1)).eval(e).value
                                        )),
    ...
    var _e = (function(e) {
        function t(e, n, i, a, s, o, u) {
            var c;
            r(this, t),
                ((c = f(this, l(t).call(this))).name = e || "anonymous mixin"),
                (c.selectors = [
                    new D([new I(null, e, !1, c._index, c._fileInfo)])
                ]),
                (c.params = n),
                (c.condition = a),
                (c.variadic = s),
            ...
            var h = [];
            return (
                (c.required = n.reduce(function(e, t) {
                    return !t.name || (t.name && !t.value)
                        ? e + 1
                        : (h.push(t.name), e);
                }, 0)),
                (c.optionalParameters = h),
                (c.frames = o),
                c.copyVisibilityInfo(u),
                (c.allowRoot = !0),
                c
            );
        }
                ...
                },
                {
                    ...
                    value: function(e, t, n, i) {
                        ...
                        if (
                            ...
                            (t = new G.Eval(t, [f].concat(t.frames))),
                            n)
                        )
                        ...
                        for (h = 0, s = 0; s < p.length; s++)
                            if (!i[s]) {
                                if (((a = n && n[h]), (u = p[s].name)))
                                    if (p[s].variadic) {
                                        for (r = [], o = h; o < v; o++)
                                            r.push(n[o].value.eval(e));
                                        f.prependRule(
                                            new q(u, new oe(r).eval(e))
                                        );
                                    } else {
                                        if ((l = a && a.value))
                                            l = Array.isArray(l)
                ...
                },
                {
                    ...
                    value: function(e, t, n) {
                        var i,
                            ...
                            a = [],
                            s = this.frames
                                ? this.frames.concat(e.frames)
                                : e.frames,
                            o = this.evalParams(e, new G.Eval(e, s), t, a);
                        return (
                            o.prependRule(
                                new q("@arguments", new oe(a).eval(e))
                            ),
                            (i = P(this.rules)),
                            ((r = new X(null, i)).originalRuleset = this),
                            (r = r.eval(new G.Eval(e, [this, o].concat(s)))),
                            n && (r = r.makeImportant()),
                            r
                        );
                    }
    ...
    var Ae = (function(e) {
        function t(e, n, i, a, s) {
            ...
            return (
                r(this, t),
                ((o = f(this, l(t).call(this))).selector = new D(e)),
                (o.arguments = n || []),
                (o._index = i),
                (o._fileInfo = a),
                (o.important = s),
                (o.allowRoot = !0),
                o.setParent(o.selector, h(o)),
                o
            );
        }
        return (
            ...
            s(t, [
                ...
                },
                {
                    ...
                    value: function(e) {
                        ...
                        function C(t, n) {
                            ...
                            for (i = 0; i < 2; i++) {
                                for (
                                    ...
                                    (a = n[r]).matchCondition &&
                                        (w[i] =
                                            w[i] && a.matchCondition(null, e));
                                t.matchCondition &&
                                    (w[i] = w[i] && t.matchCondition(m, e));
                            }
                            return w[0] || w[1]
                                ? w[0] != w[1]
                                    ? w[1]
                        ...
                        for (
                            ...
                            if (
                                ((a = (r = this.arguments[s]).value.eval(e)),
                                r.expand && Array.isArray(a.value))
                            )
                                for (a = a.value, o = 0; o < a.length; o++)
                                    m.push({ value: a[o] });
                            else m.push({ name: r.name, value: a });
                        for (
                            d = function(t) {
                            ...
                            if (
                                (t = e.frames[s].find(this.selector, null, d))
                                    .length > 0
                            ) {
                                ...
                                for (
                                    ...
                                    p[b[o].group]++;
                                if (p[x] > 0) f = I;
                                else if (((f = S), p[S] + p[I] > 1))
                                    throw {
                                        type: "Runtime",
                                        message: "Ambiguous use of `default()` found when matching for `".concat(
                                            this.format(m),
                                            "`"
                                        ),
                                        index: this.getIndex(),
                                ...
                                for (o = 0; o < b.length; o++)
                                    if ((h = b[o].group) === x || h === f)
                                        try {
                                            (n = b[o].mixin) instanceof _e ||
                                            ...
                                            this._setVisibilityToReplacement(_),
                                                Array.prototype.push.apply(
                                                    g,
                                                    _
                                                );
                ...
                },
                {
                    ...
                    value: function(e) {
                        return ""
                            .concat(this.selector.toCSS().trim(), "(")
                            .concat(
                                e
                                    ? e
                                          .map(function(e) {
            ...
            function e(t, n) {
                ...
                for (
                    ...
                    l
                        ...
                        : s < i.length &&
                          this.warn(
                              "missing required function in environment - ".concat(
                                  o
                              )
                          );
                }
                ...
                s(e, [
                    {
                        ...
                        value: function(e, t, n, i, r) {
                            ...
                            n.pluginManager &&
                                (a = []
                                    .concat(a)
                                    .concat(n.pluginManager.getFileManagers()));
                            for (var s = a.length - 1; s >= 0; s--) {
                                var o = a[s];
                                if (
                                    o[r ? "supportsSync" : "supports"](
                                        e,
                                        t,
                                        n,
                                        i
                ...
                s(e, [
                        ...
                        value: function(e, t) {
                            ...
                            for (
                                i = Math.max(
                                    ...
                                    n = 0;
                                n < i && o.directories[n] === s.directories[n];
                                n++
                            );
                            for (
                                a = o.directories.slice(n),
                                    r = s.directories.slice(n),
                                    n = 0;
                                n < a.length - 1;
                                n++
                            )
                    ...
                    },
                    {
                        ...
                        value: function(e, t) {
                            ...
                            if (!a)
                                throw new Error(
                                    "Could not parse sheet href - '".concat(
                                        e,
                                        "'"
                                    )
                                );
                            if (t && (!a[1] || a[2])) {
                                if (!(i = t.match(r)))
                                    throw new Error(
                                        "Could not parse page url - '".concat(
                                            t,
                                            "'"
                                        )
                                    );
                            ...
                            return (
                                (s.hostPart = a[1]),
                                (s.directories = l),
                                (s.rawPath = (a[1] || "") + o.join("/")),
                                (s.path = (a[1] || "") + l.join("/")),
                                (s.filename = a[4]),
                                (s.fileUrl = s.path + (a[4] || "")),
                                (s.url = s.fileUrl + (a[5] || "")),
                                s
                            );
                        }
                ...
                s(e, [
                    {
                        ...
                        value: function(e, t, n, i, r) {
                            ...
                            (l = t.pluginManager),
                                r &&
                                    (u = "string" == typeof r ? r : r.filename);
                            var h = new this.less.FileManager().extractUrlParts(
                                u
                            ).filename;
                            if (u && (s = l.get(u))) {
                                if ((c = this.trySetOptions(s, u, h, i)))
                                    return c;
                                try {
                            ...
                            if (
                                (s || (s = o.exports),
                                (s = this.validatePlugin(s, u, h)) instanceof $)
                            )
                                return s;
                            if (!s)
                                return new $(
                            ...
                            if (
                                ...
                                (s.filename = u),
                                (!s.minVersion ||
                                    this.compareVersion("3.0.0", s.minVersion) <
                                        0) &&
                                    (c = this.trySetOptions(s, u, h, i)))
                            )
                                return c;
                            if (
                                (l.addPlugin(s, r.filename, a),
                                (s.functions = a.getLocalFunctions()),
                                (c = this.trySetOptions(s, u, h, i)))
                            )
                                return c;
                            try {
    ...
    var Le = (function() {
                ...
                s(e, [
                    {
                        ...
                        value: function(e) {
                            ...
                            if (
                                ...
                                r ||
                                    ((r =
                                        i[(n = "visit".concat(e.type))] || $e),
                                    (a = i["".concat(n, "Out")] || $e),
                                    (this._visitInCache[t] = r),
                                    (this._visitOutCache[t] = a)),
                                r !== $e)
                            ) {
                                var o = r.call(i, e, s);
                                e && i.isReplacing && (e = o);
                            ...
                            return (
                                ...
                                function() {
                                    for (
                                        ...
                                        i[r] = arguments[r];
                                    (n.args = Array.prototype.slice.call(i, 0)),
                                        (n.isReady = !0),
                                        t.tryRun();
                                }
                            );
        ...
        Ne = function(e, t) {
            (this._visitor = new Le(this)),
                (this._importer = e),
                (this._finish = t),
                (this.context = new G.Eval()),
                (this.importCount = 0),
                (this.onceFileDetectionMap = {}),
                (this.recursionDetector = {}),
                (this._sequencer = new De(this._onSequencerEmpty.bind(this)));
        };
    Ne.prototype = {
        isReplacing: !1,
        run: function(e) {
        ...
        onImported: function(e, t, n, i, r, a) {
            n &&
                (n.filename ||
                    ((n.index = e.getIndex()),
                    (n.filename = e.fileInfo().filename)),
                (this.error = n));
            var s = this,
                o = e.options.inline,
            ...
            if (
                (t.importMultiple ||
                    (e.skip =
                        ...
                        function() {
                            return (
                                a in s.onceFileDetectionMap ||
                                ((s.onceFileDetectionMap[a] = !0), !1)
                            );
                        }),
                !a && u && (e.skip = !0),
                i &&
                ...
                s(e, [
                    {
                        ...
                        value: function(e) {
                            return (
                                ((e = this._visitor.visit(
                                    e
                                )).allExtends = this.allExtendsStack[0]),
                                e
                            );
                        }
                    },
                        ...
                        value: function(e, t) {
                            if (!e.root) {
                                var n,
                                    ...
                                    l = o ? o.length : 0;
                                for (n = 0; n < l; n++)
                                    e.rules[n] instanceof Me.Extend &&
                                        (s.push(o[n]),
                ...
                s(e, [
                    {
                        ...
                        value: function(e) {
                            ...
                            return (
                                this.checkExtendsForNonMatched(e.allExtends), n
                            );
                        }
                    },
                    {
                        ...
                        value: function(e) {
                            ...
                            e.filter(function(e) {
                                ...
                                t["".concat(e.index, " ").concat(n)] ||
                                    ((t[
                                        "".concat(e.index, " ").concat(n)
                                    ] = !0),
                                    Pe.warn(
                                        "extend '".concat(n, "' has no matches")
                                    ));
                            });
                        }
                    },
                        ...
                        value: function(e, t, n) {
                            ...
                            for (n = n || 0, i = 0; i < e.length; i++)
                                for (r = 0; r < t.length; r++)
                                    (l = e[i]),
                                        (u = t[r]),
                                        l.parent_ids.indexOf(u.object_id) >=
                                            0 ||
                                            ((o = [u.selfSelectors[0]]),
                                            (a = f.findMatch(l, o)).length &&
                                                ((l.hasFoundMatches = !0),
                                                l.selfSelectors.forEach(
                                                    function(e) {
                                ...
                                for (r = 0; r < s.length; r++)
                                    for (i = 0; i < e.paths.length; i++)
                                        if (
                                            ...
                                            (u && u.length) ||
                                                ((n = this.findMatch(s[r], a))
                                                    .length &&
                                                    ((s[
                                                        r
                                                    ].hasFoundMatches = !0),
                                                    s[r].selfSelectors.forEach(
                                                        function(e) {
                                                            var t;
                                                            (t = l.extendSelector(
                                                                n,
                    ...
                    },
                    {
                        ...
                        value: function(e, t) {
                            ...
                            if (
                                ((e = e.value),
                                (t = t.value),
                                e instanceof Me.Selector)
                            ) {
                                if (
                                    !(t instanceof Me.Selector) ||
                        ...
                        value: function(e, t, n, i) {
                            ...
                            for (r = 0; r < e.length; r++)
                                (a = t[(o = e[r]).pathIndex]),
                                    ...
                                    u === o.pathIndex && r > 0
                                        ...
                                        : (h = h.concat(
                                              t.slice(u, o.pathIndex)
                                          )).push(new Me.Selector(l)),
                                    (u = o.endPathIndex),
                                    (c = o.endPathElementIndex) >=
                            ...
                            return (
                                u < t.length &&
                                    ...
                                    u++),
                                (h = (h = h.concat(t.slice(u, t.length))).map(
                                    function(e) {
                    ...
                    },
                    {
                        ...
                        value: function(e, t) {
                            ...
                            (n = n.concat(
                                this.doExtendChaining(n, e.allExtends)
                            )),
    ...
    ze.prototype = {
        ...
        checkValidNodes: function(e, t) {
            if (e)
                for (var n = 0; n < e.length; n++) {
                    var i = e[n];
                    if (t && i instanceof Me.Declaration && !i.variable)
                        throw {
                            message:
        ...
        visitRuleset: function(e, t) {
            ...
            if ((this.checkValidNodes(e.rules, e.firstRoot), e.root))
                ...
                for (var r = e.rules, a = r ? r.length : 0, s = 0; s < a; )
                    (n = r[s]) && n.rules
                        ? (i.push(this._visitor.visit(n)), r.splice(s, 1), a--)
                        : s++;
                a > 0 ? e.accept(this._visitor) : (e.rules = null),
                    (t.visitDeeper = !1);
            }
            return (
                e.rules &&
                ...
                (e.paths = e.paths.filter(function(e) {
                    ...
                    for (
                        " " === e[0].elements[0].combinator.value &&
                            (e[0].elements[0].combinator = new Me.Combinator(
                                ""
                            )),
                            t = 0;
                        t < e.length;
            ...
            if (e) {
                ...
                for (i = e.length - 1; i >= 0; i--)
                    if ((n = e[i]) instanceof Me.Declaration)
                        if (r[n.name]) {
                            (t = r[n.name]) instanceof Me.Declaration &&
                                (t = r[n.name] = [
                                    r[n.name].toCSS(this._context)
                                ]);
                            var a = n.toCSS(this._context);
                            -1 !== t.indexOf(a) ? e.splice(i, 1) : t.push(a);
                        } else r[n.name] = n;
            }
        },
    ...
    var Ge = {
        ...
        We = function() {
            ...
            function v(n) {
                for (
                    ...
                    if (
                        ((i = k.charCodeAt(l.i)),
                        l.autoCommentAbsorb && i === p)
                    ) {
                        if ("/" === (o = k.charAt(l.i + 1))) {
                            d = { index: l.i, isLineComment: !0 };
                            var x = k.indexOf("\n", l.i + 2);
                            x < 0 && (x = b),
                                (l.i = x),
                                (d.text = k.substr(d.index, l.i - d.index)),
                                l.commentStore.push(d);
                            continue;
                        }
                        if ("*" === o) {
            ...
            return (
                (l.save = function() {
                    (s = l.i), o.push({ current: a, i: l.i, j: t });
                }),
                ...
                (l.$parseUntil = function(t) {
                    ...
                    do {
                        var m = e.charAt(p);
                        if (0 === s && n(m))
                            (r = e.substr(f, p - f)) ? u.push(r) : u.push(" "),
                                (r = u),
                                v(p - h),
                                (d = !1);
                        else {
        ...
        Je = function e(t, n, i) {
            ...
            function u(e) {
                var t = i.filename;
                return { lineNumber: M(e, a.getInput()).line + 1, fileName: t };
            }
            return {
                parserInput: a,
                imports: n,
                ...
                parse: function(r, s, o) {
                    ...
                    if (
                        ((u =
                            o && o.globalVars
                                ? "".concat(e.serializeVars(o.globalVars), "\n")
                                : ""),
                        (c =
                            o && o.modifyVars
                    ...
                    (u || (o && o.banner)) &&
                        ((p = (o && o.banner ? o.banner : "") + u),
                        ((h = n.contentsIgnoredChars)[i.filename] =
                            h[i.filename] || 0),
                    ...
                    try {
                        a.start(r, t.chunkInput, function(e, t) {
                            ...
                            (Me.Node.prototype.parse = this),
                            (l = new Me.Ruleset(null, this.parsers.primary())),
                            (Me.Node.prototype.rootNode = l),
                            (l.root = !0),
                            (l.firstRoot = !0),
                            (l.functionRegistry = Z.inherit());
                    } catch (e) {
                    ...
                    var y = function(e) {
                        return (e = f || e || n.error)
                            ? (e instanceof $ || (e = new $(e, n, i.filename)),
                              s(e))
                            : s(null, l);
                    };
                ...
                parsers: (r = {
                    ...
                    entities: {
                        ...
                        keyword: function() {
                            ...
                            if (e)
                                return (
                                    Me.Color.fromKeyword(e) || new Me.Keyword(e)
                                );
                        },
                        call: function() {
                            var e,
                            ...
                            if (!a.peek(/^url\(/i))
                                if (
                                    ...
                                    if (
                                        ((e = e[1]),
                                        (n = this.customFuncCall(e)) &&
                                            (t = n.parse()) &&
                                            n.stop)
                                    )
                                        return a.forget(), t;
                                    if (((t = this.arguments(t)), a.$char(")")))
                                        return (
                                            a.forget(), new Me.Call(e, t, r, i)
                                        );
                                    a.restore(
                        ...
                        assignment: function() {
                            ...
                            if ((a.save(), (e = a.$re(/^\w+(?=\s?=)/i))))
                                if (a.$char("=")) {
                                    if ((t = r.entity()))
                                        return (
                                            a.forget(), new Me.Assignment(e, t)
                                        );
                                    a.restore();
                                } else a.restore();
                            else a.restore();
                        ...
                        url: function() {
                            var e,
                                t = a.i;
                            if (((a.autoCommentAbsorb = !1), a.$str("url(")))
                                return (
                                    (e =
                                        this.quoted() ||
                                        this.variable() ||
                                    ...
                                    new Me.URL(
                                        null != e.value ||
                                        e instanceof Me.Variable ||
                                        e instanceof Me.Property
                                            ? e
                                            : new Me.Anonymous(e, t),
                                        t,
                                        i
                                    )
                                );
                        ...
                        variableCurly: function() {
                            ...
                            if (
                                ...
                                return new Me.Variable("@".concat(e[1]), t, i);
                        },
                        property: function() {
                            var e,
                                t = a.i;
                        ...
                        propertyCurly: function() {
                            ...
                            if (
                                ...
                                return new Me.Property("$".concat(e[1]), t, i);
                        },
                        color: function() {
                            var e;
                            if (
                                ...
                                return (
                                    a.forget(), new Me.Color(e[1], void 0, e[0])
                                );
                            a.restore();
                        },
                        ...
                        unicodeDescriptor: function() {
                            ...
                            if (
                                ...
                                return new Me.UnicodeDescriptor(e[0]);
                        },
                        javascript: function() {
                            var e,
                                t = a.i;
                    ...
                    variableCall: function(e) {
                        ...
                        if (
                            ...
                            return !o && r.end()
                                ? (a.forget(), u)
                                : (a.forget(),
                                  new Me.NamespaceValue(u, t, n, s, i));
                        }
                        a.restore();
                    },
                    extend: function(e) {
                        ...
                        elements: function() {
                            for (
                                var e,
                                    ...
                                    r,
                                    s,
                                    o = /^[#.](?:[\w-]|\\(?:[A-Fa-f0-9]{1,6} ?|[^A-Fa-f0-9]))+/;
                                (s = a.i), (t = a.$re(o));

                            )
                                (r = new Me.Element(n, t, !1, s, i)),
                                    e ? e.push(r) : (e = [r]),
                                    (n = a.$char(">"));
                            return e;
                        },
                            ...
                            for (a.save(); ; ) {
                                ...
                                if (
                                    (e
                                        ...
                                        : (g = u),
                                    g &&
                                        (g instanceof Me.Variable ||
                                            g instanceof Me.Property))
                                )
                                    if (a.$char(":")) {
                                        if (
                                            (p.length > 0 &&
                                ...
                                l && p.push(l),
                                    d.push({ name: o, value: l, expand: c }),
                                    a.$char(",")
                                        ? (m = !0)
                                        : ((m = ";" === a.$char(";")) || t) &&
                                          (n &&
                    ...
                    element: function() {
                        ...
                        if (
                            ...
                            (e =
                                ...
                                (a.save(),
                                a.$char("(")
                                    ? (n = this.selector(!1)) && a.$char(")")
                                        ? ((e = new Me.Paren(n)), a.forget())
                    ...
                    combinator: function() {
                        ...
                        return a.isWhitespace(-1)
                            ? new Me.Combinator(" ")
                            : new Me.Combinator(null);
                    },
                    selector: function(e) {
                        var t,
                            n,
                        ...
                        for (
                            ...
                            ((e && (n = this.extend())) ||
                                ...
                                (l = this.element())) &&
                            (c
                                ? (h = o(this.conditions, "expected condition"))
                                : h
                                ? s(
                            ...
                            if (
                                ...
                                if (
                                    ...
                                    t || (t = this.value()),
                                        t
                                            ? (r = this.important())
                                            : o && (t = this.permissiveValue());
                                }
                                if (t && (this.end() || n))
                                    return (
                                        a.forget(),
                                        new Me.Declaration(e, t, r, s, l, i)
                                    );
                                a.restore();
                            } else a.restore();
                    },
                    ...
                    permissiveValue: function(e) {
                        ...
                        if (!h()) {
                            ...
                            do {
                                (n = this.comment())
                                    ? o.push(n)
                                    : (n = this.entity()) && o.push(n);
                            } while (n);
                            if (((r = h()), o.length > 0)) {
                                if (((o = new Me.Expression(o)), r)) return o;
                                c.push(o),
                                    " " === a.prevChar() &&
                                        c.push(new Me.Anonymous(" ", u));
                            }
                            if ((a.save(), (o = a.$parseUntil(l)))) {
                                if (
                                    ("string" == typeof o &&
                                        s("Expected '".concat(o, "'"), "Parse"),
                                    1 === o.length && " " === o[0])
                                )
                                    return a.forget(), new Me.Anonymous("", u);
                                var f;
                                for (t = 0; t < o.length; t++)
                                    if (((f = o[t]), Array.isArray(f)))
                                        c.push(
                                            new Me.Quoted(f[0], f[1], !0, u, i)
                                        );
                                    else {
                                ...
                                : a.$char("(") &&
                                  ...
                                  a.$char(")")
                                      ? t && e
                                          ...
                                          : e
                                          ? r.push(new Me.Paren(e))
                                          : s(
                                                "badly formed media feature definition"
                                            )
                                      : s("Missing closing ')'", "Parse"));
                        } while (e);
                        if ((a.forget(), r.length > 0))
                            return new Me.Expression(r);
                    },
                    ...
                    media: function() {
                        ...
                        if (
                            ...
                            return (
                                ...
                                a.forget(),
                                (r = new Me.Media(n, e, l, i)),
                                t.dumpLineNumbers && (r.debugInfo = o),
                                r
                            );
                        a.restore();
                    },
                        ...
                        if (a.$re(/^@plugin?\s+/)) {
                            if (
                                ...
                                return (
                                    a.$char(";") ||
                                        ((a.i = r),
                                        s("missing semi-colon on @plugin")),
                                    new Me.Import(e, null, n, r, i)
                                );
                    ...
                    sub: function() {
                        var e, t;
                        if ((a.save(), a.$char("(")))
                            return (e = this.addition()) && a.$char(")")
                                ? (a.forget(),
                                  ((t = new Me.Expression([e])).parens = !0),
                                  t)
                                : void a.restore("Expected ')'");
                        a.restore();
                    },
                    ...
                    conditionAnd: function(e) {
                        ...
                        if (
                            (t =
                                (r =
                                    s.negatedCondition(e) ||
                                    s.parenthesisCondition(e)) || e
                                    ? r
                                    : s.atomicCondition(e))
                        ) {
                            if ((n = a.$str("and"))) {
                    ...
                    operand: function() {
                        ...
                        return (
                            e &&
                                ((n.parensInOp = !0), (n = new Me.Negative(n))),
                            n
                        );
                    },
                    expression: function() {
                    ...
                    ruleProperty: function() {
                        ...
                        if (s)
                            return (n = [new Me.Keyword(s[1])]), a.forget(), n;
                        function o(e) {
                            var t = a.i,
                                i = a.$re(e);
    ...
    var tt = (He = {
        ...
        rgba: function(e, t, n, i) {
            try {
                if (e instanceof y)
                    return (i = t ? et(t) : e.alpha), new y(e.rgb, i, "rgba");
        ...
        hsla: function(e, t, n, i) {
            try {
                ...
                if (e instanceof y)
                    return (i = t ? et(t) : e.alpha), new y(e.rgb, i, "hsla");
                (e = (et(e) % 360) / 360),
                    (t = Ke(et(t))),
                    (n = Ke(et(n))),
                    (i = Ke(et(i))),
                    (r = 2 * n - (a = n <= 0.5 ? n * (t + 1) : n + t - n * t));
        ...
        hsva: function(e, t, n, i) {
            ...
            var s = [
                    n,
                    n * (1 - t),
                    n * (1 - (a = e / 60 - (r = Math.floor((e / 60) % 6))) * t),
                    n * (1 - (1 - a) * t)
                ],
                o = [
                    [0, 3, 1],
        ...
        contrast: function(e, t, n, i) {
            if (!e.rgb) return null;
            if (
                (void 0 === n && (n = He.rgba(255, 255, 255, 1)),
                void 0 === t && (t = He.rgba(0, 0, 0, 1)),
                t.luma() > n.luma())
            ) {
                var r = n;
                (n = t), (t = r);
            }
            return (i = void 0 === i ? 0.43 : et(i)), e.luma() < i ? n : t;
        },
        argb: function(e) {
        ...
        color: function(e) {
            ...
            if (e instanceof y || (e = y.fromKeyword(e.value)))
    ...
    for (var rt in it)
        it.hasOwnProperty(rt) && (nt[rt] = nt.bind(null, it[rt]));
    var at = function(e) {
    ...
    for (var ut in lt)
        lt.hasOwnProperty(ut) && (lt[ut] = ot.bind(null, Math[ut], lt[ut]));
    ...
    var ct,
        ht = function(e, t) {
            ...
            return 1 == c.length
                ...
                : ((t = c
                  ...
                  new B("".concat(e ? "min" : "max", "(").concat(t, ")")));
        },
        ft = {
            min: function() {
                for (
        ...
        mt = {
            ...
            unit: function(e, t) {
                ...
                return (
                    (t = t ? (t instanceof j ? t.value : t.toCSS()) : ""),
                    new ie(e.value, t)
                );
            },
            "get-unit": function(e) {
        ...
        gt = function(e) {
            var t = { functionRegistry: Z, functionCaller: le };
            return (
                Z.addMultiple(Qe),
                Z.add("default", Y.eval.bind(Y)),
                Z.addMultiple(tt),
                Z.addMultiple(nt),
                Z.addMultiple(
                    (function(e) {
                        var t = function(e, t) {
                            return new ve(t, e.index, e.currentFileInfo).eval(
                                e.context
                            );
                        };
                        return {
        ...
        yt = function(e) {
            ...
            "object" !== i(r) ||
                ...
                ((r = Object.keys(r).map(function(e) {
                    var t = r[e];
                    return (
                        t instanceof Me.Value ||
                            (t instanceof Me.Expression ||
                                (t = new Me.Expression([t])),
                            (t = new Me.Value([t]))),
                        new Me.Declaration("@".concat(e), t, !1, null, 0)
                    );
                })),
            ...
            var s,
                o,
                l = [
                    new Ge.JoinSelectorVisitor(),
                    new Ge.MarkVisibleSelectorsVisitor(!0),
                    new Ge.ExtendVisitor(),
                    new Ge.ToCSSVisitor({ compress: Boolean(n.compress) })
                ],
                u = [];
            if (n.pluginManager) {
                    ...
                    for (o.first(); (s = o.get()); )
                        s.isPreEvalVisitor
                            ? (0 !== c && -1 !== u.indexOf(s)) ||
                              (u.push(s), s.run(e))
                            : (0 !== c && -1 !== l.indexOf(s)) ||
                              (s.isPreVisitor ? l.unshift(s) : l.push(s));
            }
            t = e.eval(a);
            for (c = 0; c < l.length; c++) l[c].run(t);
            if (n.pluginManager)
                for (o.first(); (s = o.get()); )
                    -1 === l.indexOf(s) && -1 === u.indexOf(s) && s.run(t);
            return t;
        },
        bt = (function() {
            function e(t) {
                r(this, e),
                    ...
                    (this.iterator = -1),
                    (this.pluginCache = {}),
                    (this.Loader = new t.PluginLoader(t));
            }
            return (
                s(e, [
                    {
            ...
            var n,
                i = (function(e) {
                    return (function() {
                        function t(n) {
                            r(this, t),
                                (this._css = []),
                                (this._rootNode = n.rootNode),
                                (this._contentsMap = n.contentsMap),
                                (this._contentsIgnoredCharsMap =
                                    n.contentsIgnoredCharsMap),
                                n.sourceMapFilename &&
                                    (this._sourceMapFilename = n.sourceMapFilename.replace(
                                        /\\/g,
                                        "/"
                                    )),
                                (this._outputFilename = n.outputFilename),
                                (this.sourceMapURL = n.sourceMapURL),
                                n.sourceMapBasepath &&
                                    (this._sourceMapBasepath = n.sourceMapBasepath.replace(
                                        /\\/g,
                                        "/"
                                    )),
                                n.sourceMapRootpath
                                    ? ((this._sourceMapRootpath = n.sourceMapRootpath.replace(
                                          /\\/g,
                                          "/"
                                      )),
                                      "/" !==
                                    ...
                                    : (this._sourceMapRootpath = ""),
                                (this._outputSourceFiles = n.outputSourceFiles),
                                    ...
                                    value: function(e) {
                                        if (
                                            ...
                                            for (var t in this._contentsMap)
                                                if (
                                                    this._contentsMap.hasOwnProperty(
                                                        t
                                                    )
                                                ) {
                                                    var n = this._contentsMap[
                                                        t
                                                    ];
                                                    this
                                                        ._contentsIgnoredCharsMap[
                            ...
                            s(t, [
                                {
                                    ...
                                    value: function(t) {
                                        ...
                                        if (t.pluginManager)
                                            for (
                                                var o = t.pluginManager.getPostProcessors(),
                                                    l = 0;
                                                l < o.length;
                                                l++
                                            )
                                                r.css = o[l].process(r.css, {
                                                    sourceMap: i,
                                                    options: t,
                                        ...
                                        (r.imports = []),
                                        this.imports.files))
                                            this.imports.files.hasOwnProperty(
                                                u
                                            ) &&
                                                u !==
                                                    this.imports.rootFilename &&
                                                r.imports.push(u);
                                        return r;
                                    }
                                }
                            ...
                            s(t, [
                                {
                                    ...
                                    value: function(t, n, i, r, a) {
                                        ...
                                        if (c) {
                                            ...
                                            l({
                                                message: "Could not find a file-manager for ".concat(
                                                    t
                                                )
                                            });
                                    }
                ...
                h = (function(e, t, n) {
                    return function e(t, i, r) {
                        ...
                        var s,
                            o,
                            l = new wt(this, !i.reUsePluginManager);
                        if (
                            ((i.pluginManager = l),
                            (s = new G.Parse(i)),
                            i.rootFileInfo)
                ...
                d = Object.create(p);
            for (var g in p.tree)
                if ("function" == typeof (n = p.tree[g]))
                    d[g.toLowerCase()] = v(n);
                else
                    for (var y in ((d[g] = Object.create(null)), n))
                        d[g][y.toLowerCase()] = v(n[y]);
            return d;
        },
        It = {},
        Ct = (function(e) {
                    ...
                    },
                    {
                        ...
                        value: function(e, t, n, i) {
                            ...
                            "function" == typeof r.overrideMimeType &&
                                ...
                                r.send(null),
                                kt.isFileProtocol && !kt.fileAsync
                                    ? 0 === r.status ||
                    ...
                    },
                    {
                        ...
                        value: function(e, t, n, i) {
                            t && !this.isPathAbsolute(e) && (e = t + e),
                                (e = n.ext
                                    ? this.tryAppendExtension(e, n.ext)
                                    : e),
                                (n = n || {});
                    ...
                    r.errorReporting && "html" !== r.errorReporting
                        ? "console" === r.errorReporting
                            ...
                            : "function" == typeof r.errorReporting &&
                              r.errorReporting("add", a, s)
                        : (function(i, a) {
                              var s,
                                  o,
                                  l = "less-error-message:".concat(e(a || "")),
    ...
    if (window.less)
        for (var Et in window.less)
            window.less.hasOwnProperty(Et) && (Pt[Et] = window.less[Et]);
    !(function(e, i) {
        t(i, n.currentScript(e)),
        ...
        window.LESS_PLUGINS &&
            (Pt.plugins = Pt.plugins.concat(window.LESS_PLUGINS));
    var Rt,
        Ot,
        Ft,
        Vt = (function(e, i) {
            ...
            !(function() {
                ...
                i.functions &&
                    a.functions.functionRegistry.addMultiple(i.functions);
            var h = /^text\/(x-)?less$/;
            function f(e) {
                var t = {};
                for (var n in e) e.hasOwnProperty(n) && (t[n] = e[n]);
                            ...
                            !(function(t) {
                                ...
                                if (
                                    ...
                                    if (!r && v)
                                        return (
                                            (h.local = !0),
                                            void n(null, v, i, e, h, s)
                                        );
                                }
                                u.remove(s),
                                    (p.rootFileInfo = f),
                                    a.render(i, p, function(t, r) {
                                        t
                                            ? ((t.href = s), n(t))
                                            : (c.setCSS(
                                                  e.href,
            ...
            function m(e, t, n) {
                for (var i = 0; i < a.sheets.length; i++)
                    d(a.sheets[i], e, t, a.sheets.length - (i + 1), n);
            }
            return (
                (a.watch = function() {
                    return (
                        a.watchMode ||
                            ((a.env = "development"),
                            "development" === a.env &&
                                (a.watchTimer = setInterval(function() {
                                    a.watchMode &&
                                        (l.clearFileCache(),
                                        m(function(t, i, r, a, s) {
                                            t
                                                ? u.add(t, t.href || a.href)
                                                : i &&
                                                  n.createCSS(e.document, i, a);
                                        }));
                                }, i.poll))),
                        (this.watchMode = !0),
                        !0
                ...
                (a.unwatch = function() {
                    return (
                        clearInterval(a.watchTimer), (this.watchMode = !1), !1
                    );
                }),
    ...
    return (
        ...
        Pt.onReady &&
            ...
            Pt.async ||
                ((Rt = "body { display: none !important }"),
                (Ot =
                    document.head || document.getElementsByTagName("head")[0]),
                ((Ft = document.createElement("style")).type = "text/css"),
                Ft.styleSheet
                    ? (Ft.styleSheet.cssText = Rt)
                    : Ft.appendChild(document.createTextNode(Rt)),
                Ot.appendChild(Ft)),
