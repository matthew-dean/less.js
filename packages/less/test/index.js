...
var testMap = [
  ...
  [
    { math: 'strict', strictUnits: true, javascriptEnabled: false },
    'no-js-errors/',
    lessTester.testErrors,
    null
  ],
  [
    { math: 'strict', dumpLineNumbers: 'comments' },
    'debug/',
    null,
    function (name) {
  ...
  [
    { math: 'strict', dumpLineNumbers: 'mediaquery' },
    'debug/',
    null,
    function (name) {
  ...
  [
    { math: 'strict', dumpLineNumbers: 'all' },
    'debug/',
    null,
    function (name) {
      return name + '-all'
  ...
  [{}, 'legacy/'],
  [
    { math: 'strict', strictUnits: true, sourceMap: true, globalVars: true },
    'sourcemaps/',
  ...
  [
    { math: 'strict', strictUnits: true, globalVars: true },
    '_main/import/json/',
    lessTester.testImports,
    null,
    true,
    function (filename, type, baseFolder) {
      return path.join(baseFolder, filename) + '.json'
  ...
  [
    ...
    lessTester.testSourcemapWithoutUrlAnnotation
  ],
  [
  ...
  [
    { rootpath: 'http://example.com/assets/css/', rewriteUrls: 'all' },
    'rootpath-rewrite-urls-all/'
  ],
  [
    { rootpath: 'http://example.com/assets/css/', rewriteUrls: 'local' },
