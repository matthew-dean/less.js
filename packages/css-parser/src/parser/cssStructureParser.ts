...
export class CssStructureParser extends BaseParserClass {
    ...
    expressionListGroup = this.RULE<CstNode | undefined>(
        "expressionListGroup",
        () => {
            let isGroup = false;
    ...
    customExpressionList = this.RULE<CstNode | undefined>(
     ...
     */
    customExpression = this.RULE<CstNode | undefined>(
        "customExpression",
        () => {
        ...
        this.OR([
            {
                ALT: () => {
                    this.OR2([
                        ...
                        {
                            ALT: () =>
                                (Function = this.CONSUME(this.T.Function))
                        }
                    ]);
